...
(function() {
  ...
  QMovement.diagonalSpeed = Number(_PARAMS['Diagonal Speed'] || 0);
...
Game_CharacterBase.prototype.moveDiagonally = function(horz, vert, dist) {
    ...
    // Applica il modificatore di velocità diagonale
    if (QMovement.diagonalSpeed && QMovement.diagonalSpeed > 0) {
      dist *= QMovement.diagonalSpeed;
    }
